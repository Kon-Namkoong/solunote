package com.vol.solunote.menu27.controller;
...
import com.vol.solunote.menu27.service.Menu27Service;
...
@Controller
@Slf4j
@RequestMapping("/menu27")
public class Menu27Controller extends DefaultController {
...
//	        String userId = Util.getSessionAttr("userId");
			...
			List<Map<String, Object>> list = menu27Service.userinfo(tcId);	 
			
			model.addAttribute("list", list);

		}else {
			MenuList = menu27Service.getAuthList();
	...
	public String loadList(Model model,
        ...
        pages = menu27Service.getList(activeMenu,offsetPageable,userType, tcId ,tcName,tcPhone, searchStartDate, searchEndDate);
	...
	public String settingList(Model model,
        ...
        pages = menu27Service.getSettingList(offsetPageable,useYn,searchType,searchKeyword,searchStartDate,searchEndDate);
	...
	public String check(@Param("code") String code) throws Exception {
		return String.valueOf(menu27Service.checkCode(code));
	}
	...
	public String insert(Model model, @RequestParam Map<String,String> paramMap) throws Exception {
		...
		json = menu27Service.insertContents(paramMap);
	...
	public String deleteUser(
		...
		if(activeMenu == 1) {
			menu27Service.deleteUser(userId);
		}else if (activeMenu == 2) {
			menu27Service.saveUser(userId);
		}
	...
	public String permanentlyUser(
		...
		menu27Service.permanentlyUser(userId);
	...
	public String userinfo(Model model,
		...
		List<Map<String, Object>> list = menu27Service.userinfo(userId);
	...
	public String changeUserInfo(
		...
		menu27Service.changeUserinfo(tcId,tcPw,tcName,tcPhone,tcEmail,tcLevel,"changeUserInfo");
    ...
    public int checkSetting(
        ...
        return menu27Service.checkSetting(settingTitle);
    }	
    ...
    public String settingRes(
        ...
        menu27Service.settingRes(settingTitle,settingValue,settingUseYn,settingDetail);
	...
	public String settingInfo(Model model,
		...
		List<Map<String, Object>> list = menu27Service.settingInfo(settingTitle);
	...
	public String changeSettinInfo(
		...
		menu27Service.changeMeetingInfo(settingTitleChange,settingValueChange,settingUseYnChange,settingDetailChange);
	...
	public String deleteSettingInfo(
			...
			menu27Service.deleteSettingInfo(settingTitle);
...
//		Resource resource = (Resource) param.get("resource");
	...
	public void excelForm(
		...
		menu27Service.excelForm(response);
	...
	public String upload(
        ...
        pages = menu27Service.getExcelList(file);
