package com.vol.solunote.menu22.controller;
...
import com.vol.solunote.menu21.controller.Menu21Controller;
import com.vol.solunote.menu22.service.Menu22Service;
...
@Controller
@RequestMapping("/menu22")
@Slf4j
public class Menu22Controller extends DefaultController {
	...
	@Autowired
    private  Menu22Service menu22Service;

	private final CustomHttpSessionListener httpSessionListener;    
	
    
    Menu22Controller(Menu22Service menu22Service, CustomHttpSessionListener httpSessionListener) {
        this.menu22Service = menu22Service;
    ...
    public String cont(HttpServletRequest request, Model model, @RequestParam(required = false) Integer seq, @Param("search") DefaultVo search) throws Exception {
        ...
        model.addAttribute("processingFileCnt", Menu21Controller.processingFileCnt);
    ...
    public Map <String, Object> dashboardCard(Model model, @RequestParam String startDate, @RequestParam String endDate) throws Exception {
        ...
        int userCount = menu22Service.countByCreatedAtBetweenAndGroupDate(startDate, endDate);
        Map<String, Object> map = menu22Service.analyticsAvgMeeting(startDate, endDate);
    ...
    public List <LoginLogProjectionVo> userCountGroupDate(Model model, @RequestParam String startDate, @RequestParam String endDate) throws Exception {
        ...
        List<LoginLogProjectionVo> dateUserCountMap = menu22Service.countUserGroupDate(startDate, endDate);
    ...
    public List <Map <String, Object>> fileCountGroupDate(Model model, @RequestParam String startDate, @RequestParam String endDate) throws Exception {
        ...
        List<Map <String, Object>> fileCountGroupDate = menu22Service.fileCountGroupDate(startDate, endDate);
